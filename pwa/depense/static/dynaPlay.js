...
HTMLElement.prototype.printOne = function (varName, varValue){
	if (! exists (varValue)){
		...
		for (var a=0; a< this.attributes.length; a++) if (this.attributes[a].value.includes ('((' + varName + '))')) this.attributes[a].replace ('((' + varName + '))', "");
	}
...
HTMLElement.prototype.printFor = function(){
	if (this.innerHTML.includes ('list=')) for (var c=0; c< this.children.length; c++) this.children[c].printFor();
